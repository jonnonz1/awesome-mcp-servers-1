...
- <img src="https://goshipyard.app/icons/icon-192.png" height="14"/> [Shipyard](https://github.com/jonnonz1/goshipyard) - Hosted MCP server (Streamable HTTP) that lets your coding agent ship, review, and manage its own launches on Shipyard, a feed for vibe-coded projects. Anonymous read tools plus key-gated ship/review/like/wallet tools at https://goshipyard.app/mcp.
